...
- (void)viewDidLoad
{
    ...
    //self.secdetailViewController = (tyxsecdetaiViewController *)[self.splitViewController.viewControllers lastObject];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        cell.textLabel.text = @"Third Detail View Controller";
    }
