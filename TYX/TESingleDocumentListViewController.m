...
//    NSLog(@"%@",path);
    ...
    fileNameList = [[NSArray alloc] initWithObjects:@"Lateral1",@"Lateral2", @"PDF-File",@"localPDF", @"Lateral3", nil];
    
	//set up pdfpath
    pdfPath = [[NSBundle mainBundle] pathForResource:@"lateral.0002" ofType:@"jpg"];
    imagePath = [[NSBundle mainBundle] pathForResource:@"lateral.0001" ofType:@"jpg"];
    //imagePath = [[NSBundle mainBundle] pathForResource:@"Neuro Spine" ofType:@"jpg"];
    bildPath = [[NSBundle mainBundle] pathForResource:@"lateral.0003" ofType:@"jpg"];
