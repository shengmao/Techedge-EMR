...
- (void)viewDidLoad
{
    ...
    fileNameList = [[NSArray alloc] initWithObjects:@"Lateral1",@"Knie rechts", @"QLPreview",@"localPDF", nil];
    ...
    bildPath = [[NSBundle mainBundle] pathForResource:@"Lateral.0001" ofType:@"jpg"];
